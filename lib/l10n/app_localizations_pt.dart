...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get batterySaverTitle => 'Economia de bateria';

  @override
  String get batterySaverSubtitle =>
      'Limita a taxa de atualização para poupar bateria';
  ...
  @override
  String get hintRevealWord => 'Revelar palavra';

  @override
  String hintRevealWordCost(int count) {
    return 'Revelar palavra (-$count)';
  }
  ...
  String get updateDownloadingBody =>
      'Baixando a atualização em segundo plano…';
